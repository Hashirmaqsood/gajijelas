...
export const GUIDES: Guide[] = [
  ...
  {
    slug: "is-your-salary-good-in-malaysia",
    title: "Is Your Salary Good in Malaysia? What the Data Says",
    description:
      "Is RM7,000 or RM25,000 a good salary in Malaysia? Real DOSM wage data — not opinion — to actually benchmark your pay against.",
    publishedDate: "2026-09-24",
    body: [
      "\"Is my salary good?\" is one of the most searched questions about pay in Malaysia, and almost every answer online is a guess dressed up as advice. There's an actual, official answer: the Department of Statistics Malaysia (DOSM) publishes real wage data every quarter. Here's what it actually says, as of the latest release.",
      "## The real national benchmark",
      "DOSM's Employee Wages Statistics (Formal Sector) report for Q4 2025, released 29 April 2026, puts the median monthly wage for Malaysian formal-sector employees at RM3,167 (December 2025) — up 4.0% from RM3,045 a year earlier. Percentile data from the same release shows the bottom 10% of formal employees earned RM1,700 or less, while the top 10% (the 90th percentile) earned at least RM11,122 a month.",
      "## So is RM7,000 a good salary?",
      "RM7,000 sits well above the national median of RM3,167 — more than double it — though it's still short of the RM11,122 threshold that marks the top 10% of earners. In plain terms: comfortably above average, not yet in the very top bracket.",
      "## And RM25,000?",
      "RM25,000 is more than double the RM11,122 threshold for the top 10% of Malaysian formal employees. That places it firmly in the highest-earning bracket nationally, by DOSM's own numbers — not a subjective call.",
      "## Where you live changes the answer",
      "The same salary buys very different things depending on where you are. DOSM's December 2025 figures show Kuala Lumpur's median wage at RM4,391, Penang at RM3,500 and Selangor at RM3,400 — all well above Kelantan's RM1,800, Perlis's RM1,864 and Sabah's RM2,045. A salary that looks average in KL would be well above the local median in several other states, and vice versa — the honest comparison is against your own state, not the national figure alone.",
      "## Age and experience change it too",
      "DOSM also breaks median wages down by age band. Employees aged 45–49 recorded the highest median in Q4 2025 (reaching RM4,245 in December), while employees under 20 had a median of RM1,700. Comparing your salary against your own age group's median is usually more useful than the all-ages national figure, especially early or late in a career.",
      "## The number that actually matters more: take-home pay",
      "Two people on the same gross salary can end up with meaningfully different take-home pay, depending on age, marital status, number of children and EPF/SOCSO category. Gross salary benchmarks are a starting point, not the full picture — what actually lands in your bank account after EPF, SOCSO, EIS and PCB is the number worth comparing.",
    ],
    relatedLinks: [
      { href: "/", label: "Full Salary Calculator" },
      { href: "/pcb-calculator", label: "PCB Calculator (MTD)" },
  ...
  {
    slug: "salary-calculation-30-or-31-days-malaysia",
    title: "Is Salary Calculated on 30 or 31 Days in Malaysia?",
    description:
      "The Employment Act's real formula for partial-month salary uses the actual days in that month, not a fixed 30 — here's how it actually works.",
    publishedDate: "2026-09-24",
    body: [
      "Your monthly salary is a fixed number, so it's a fair question: when you only work part of a month — you start mid-month, resign before month-end, or take a stretch of unpaid leave — is that partial pay worked out on 30 days, 31 days, or something else? The answer is more specific than most explanations online suggest.",
      "## The legal default: the actual number of days in that month",
      "Under the Employment Act 1955 (Section 18A, read together with Section 60I(2)), the statutory formula for an incomplete month of work is: monthly wage ÷ the number of days in that particular wage period, × the number of days the employee actually worked or was entitled to be paid for. \"The number of days in that particular wage period\" means the real calendar length of that specific month — 28 or 29 in February, 30 in April, June, September and November, and 31 in the rest. It is not a fixed divisor.",
      "## Why you'll still see companies use a flat 26 or 30",
      "Employers are allowed to use a different, simpler method — a fixed divisor of 26 or 30, for example — but only if the result is equal to or more generous than what the calendar-day formula would give the employee. A flat divisor that would pay the employee less than the statutory formula isn't compliant, even if it's what's written in the employment contract. So both approaches exist in practice, and the one that matters legally is whichever produces the larger number for the employee.",
      "## A worked example",
      "Say your monthly salary is RM5,000 and you start a new job on 16 February 2026 — a month with 28 days. Under the statutory formula, you'd be paid for 13 days out of 28: RM5,000 ÷ 28 × 13 = RM2,321.43. If your employer instead used a fixed 30-day divisor, you'd get RM5,000 ÷ 30 × 13 = RM2,166.67 — less than the statutory result, which would not be compliant. A fixed divisor only becomes legal here if it's adjusted so the outcome is at least as favourable as the calendar-day method.",
      "## When this actually comes up",
      "This only affects partial months — starting or leaving mid-month, or unpaid leave spanning part of a pay period. A full calendar month worked in full is paid at your full monthly salary regardless of whether that month has 28, 30 or 31 days; the divisor only changes the answer when you're being paid for less than the whole period.",
    ],
    relatedLinks: [
      { href: "/hourly-rate-calculator", label: "Hourly & Daily Rate Calculator" },
      { href: "/guides/first-paycheck-malaysia-what-to-expect", label: "What Your First Paycheck Actually Looks Like" },
