...
const DESCRIPTION = "Free SOCSO calculator for Malaysia — work out your PERKESO employment injury, invalidity, EIS and new LINDUNG 24 Jam contributions, with the RM6,000 wage ceiling applied automatically.";
